...
const CouponEdit = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(endpoints.coupon.update, couponData, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
            ...
            if (response.data.isSuccess) {
                ...
                toast.error(`Failed to update coupon. ${response.data.message}`);
            }
        }
        catch (err) {
    ...
    return (
        <div className="container border p-3">
            <h1 className="text-center">Edit Coupon</h1>
            <form onSubmit={handleSubmit}>
                ...
                <div className="row">
                    ...
                    <div className="col-5">
                        <button type="submit" className="btn btn-success">Update Coupon</button>
